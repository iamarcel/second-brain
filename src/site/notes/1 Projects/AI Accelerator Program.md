...
- The Program
	- Customer Support
		- €300K: Brussels fiscality chatbot
	- Lead Generation
	...
	- Social Media Automation
		...
		- Making shorts from long-form content
			...
			- 5 shorts per week = 5 * 50 * 1.5h = €23,437.5
...
- Two types of YouTube videos: inspirational, pulling a wider less-technical beginner-friendly audience of business owners—then more hands-on showing that I know what I'm doing.
...
- Linkedin Viral Poster Bot
	...
	- Choose Topic → Write Post → Publish Post
...
- Quote of The Day Bot
	...
	- Quote Topic → Quote Finder → Save Quote → Upload to Cloudinary → Post To Instagram/Facebook
- Generated Art Bot
...
- Google Maps Cold Email Bot
	...
	- Scrape Google Maps → Scrape Emails from URL → Write Email Subject Line → Write Email Copy → Send Email
- Cold Outreach Email Bot
	...
	- Build a list → Write an email → Send an Email
- Sales Letter Writer Bot
	...
	- New Jotform Submission → Write Title → Save Sales Letter → Set Letter Style → Write Sales Page → Send to Google Docs
- Direct Mail Outreach Bot
	...
	- Take Contact List → Create A Contact → Write Letter → Send Letter
...
- YouTube Distribution Bot
	...
	- Grab Channel Video → Write A Post → Post To LinkedIn
...
- SEO Blog Writer Bot
	...
	- Get Airtable Record → Write a Blog → Update Record → Publish on Webflow
